...
BOARD_KERNEL_CMDLINE := \
    ...
    lz4asm.support=1 \
    swinfo.fingerprint=$(ROM_FINGERPRINT) \
    mtdoops.fingerprint=$(ROM_FINGERPRINT) \
    bootmonitor.fingerprint=$(ROM_FINGERPRINT)
...
# Release artifacts use a device-specific signing identity and
# verification-enabled vbmeta.
XIAOMI_SM8750_AVB_KEY_PATH ?= vendor/$(TARGET_DEVICE)/security/avb.pem
BOARD_AVB_ALGORITHM := SHA256_RSA4096
BOARD_AVB_KEY_PATH := $(XIAOMI_SM8750_AVB_KEY_PATH)
BOARD_AVB_MAKE_VBMETA_IMAGE_ARGS := --flags 0
BOARD_MOVE_GSI_AVB_KEYS_TO_VENDOR_BOOT := true

BOARD_AVB_BOOT_KEY_PATH := $(XIAOMI_SM8750_AVB_KEY_PATH)
BOARD_AVB_BOOT_ALGORITHM := SHA256_RSA4096
BOARD_AVB_BOOT_ROLLBACK_INDEX := $(XIAOMI_SM8750_SECURITY_PATCH_TIMESTAMP)
BOARD_AVB_BOOT_ROLLBACK_INDEX_LOCATION := 3

BOARD_AVB_RECOVERY_KEY_PATH := $(XIAOMI_SM8750_AVB_KEY_PATH)
...
BOARD_AVB_VBMETA_SYSTEM_KEY_PATH := $(XIAOMI_SM8750_AVB_KEY_PATH)
